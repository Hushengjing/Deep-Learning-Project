...
def conv2d_maxpool(x_tensor, conv_num_outputs, conv_ksize, conv_strides, pool_ksize, pool_strides):
    ...
    # print(channel)
    w = tf.Variable(tf.truncated_normal([*conv_ksize, channel, conv_num_outputs]))
...
def fully_conn(x_tensor, num_outputs):
    ...
    # TODO: Implement Function
    channel = x_tensor.get_shape().as_list()[-1]
    w = tf.Variable(tf.truncated_normal([channel, num_outputs]))
...
def conv_net(x, keep_prob):
    ...
    c2 = conv2d_maxpool(d1, conv_num_outputs=32, conv_ksize=[3,3], conv_strides=[1,1], pool_ksize=[2,2], pool_strides=[1, 1])
    d2 = tf.nn.dropout(c2, keep_prob)
    c3 = conv2d_maxpool(d2, conv_num_outputs=64, conv_ksize=[2,2], conv_strides=[1,1], pool_ksize=[2,2], pool_strides=[1, 1])
